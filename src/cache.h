...
extern unsigned long long L2_access[2];
extern unsigned long long L2_hit[2];
...
typedef struct CacheLine
{
    ...
    /* This shall be needed to identify the core to which a cache line (way) is assigned to in a multicore scenario */
    unsigned int core_id;

    /* helps to keep track of individual last access times of the cache lines, which helps identify the LRU way */
